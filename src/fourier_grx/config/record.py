...
class Record:
    def __init__(self):
        ...
        # 初始化 Record 对象，设置默认路径
        # 步骤1，默认先找 ~/fourier-grx/record/robot_name 目录
        # 步骤2，如果没有找到，则使用 gl_config.parameters 中的 "record" 字段的 "path" 值
        # 步骤3，如果 "path" 值为 None 或 "None"，则使用当前目录下的 record/robot_name 目录
        ...
        try:
            ...
            """
            path = gl_config.parameters.get("record", {}).get("path", None)
