...
from fourier_grx.algorithm.robot_real.fi_algorithm_robot_real_find_home import (
    AlgorithmRobotRealFindHomeControlModel,
)
...
class TaskRobotRealFindHome(TaskRobotRealBase):
    def register(
            self,
        ...
        self.task_model = AlgorithmRobotRealFindHomeControlModel()
        self.task_key = TaskMenuRobotReal.TASK_FIND_HOME
    ...
    def _function_meta(self, **kwargs) -> FunctionResult:
        ...
        if self.task_model.stage == AlgorithmStage.STAGE_INIT:
            ...
            for actuator in robot.actuators:
                actuator.set_target_control_mode(ActuatorControlMode.FIND_HOME)
