...
from fourier_grx.algorithm.robot_real.fi_algorithm_robot_real_pause_motion import (
    AlgorithmRobotRealPauseMotionControlModel,
)
...
class TaskRobotRealPauseMotion(TaskRobotRealBase):
    def register(
            self,
        ...
        self.task_model = AlgorithmRobotRealPauseMotionControlModel()
        self.task_key = TaskMenuRobotReal.TASK_PAUSE_MOTION
    ...
    def _function_meta(self, **kwargs) -> FunctionResult:
        ...
        if self.task_model.stage == AlgorithmStage.STAGE_INIT:
            ...
            for actuator in robot.actuators:
                actuator.set_target_control_mode(ActuatorControlMode.VELOCITY)
