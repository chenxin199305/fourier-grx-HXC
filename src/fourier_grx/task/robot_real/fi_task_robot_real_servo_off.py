...
from fourier_grx.algorithm.robot_real.fi_algorithm_robot_real_servo_off import (
    AlgorithmRobotRealServoOffControlModel,
)
...
class TaskRobotRealServoOff(TaskRobotRealBase):
    def register(
            self,
        ...
        self.task_model = AlgorithmRobotRealServoOffControlModel()
        self.task_key = TaskMenuRobotReal.TASK_SERVO_OFF
    ...
    def _function_meta(self, **kwargs) -> FunctionResult:
        ...
        if self.task_model.stage == AlgorithmStage.STAGE_INIT:
            ...
            for actuator in robot.actuators:
                actuator.set_target_control_mode(ActuatorControlMode.SERVO_OFF)
