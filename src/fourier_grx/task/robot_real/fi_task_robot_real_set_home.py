...
from fourier_grx.algorithm.robot_real.fi_algorithm_robot_real_set_home import (
    AlgorithmRobotRealSetHomeControlModel,
)
...
class TaskRobotRealSetHome(TaskRobotRealBase):
    def register(
            self,
        ...
        self.task_model = AlgorithmRobotRealSetHomeControlModel()
        self.task_key = TaskMenuRobotReal.TASK_SET_HOME
    ...
    def _function_meta(self, **kwargs) -> FunctionResult:
        ...
        if self.task_model.stage == AlgorithmStage.STAGE_INIT:
            ...
            for actuator in robot.actuators:
                actuator.set_target_control_mode(ActuatorControlMode.SET_HOME)
